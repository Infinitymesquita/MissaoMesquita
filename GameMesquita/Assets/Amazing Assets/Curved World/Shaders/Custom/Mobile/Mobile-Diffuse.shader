...
Shader "Amazing Assets/Curved World/Mobile/Diffuse" 
{
    Properties 
    {
        [HideInInspector][CurvedWorldBendSettings]	  _CurvedWorldBendSettings("0,2,3|1|1", Vector) = (0, 0, 0, 0)
...
#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_POSITIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_NEGATIVE
